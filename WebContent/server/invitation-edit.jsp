    ...
    <div class="x-body">
        ...
        <div class="layui-form-item">
              <label for="username" class="layui-form-label">
                  <span class="x-red">*</span>帖子Id
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="invitationId" name="invitationId" required="" lay-verify="invitationId"
                  autocomplete="off" class="layui-input" value="${invitation.invitationId}" readonly="readonly"> 
              </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-form-mid layui-word-aux">
                  <span class="x-red">*</span>模块介绍
              </div>
          </div>
          <div class="layui-form-item">
              <label for="phone" class="layui-form-label">
                  <span class="x-red">*</span>所属标题
              </label>
              <div class="layui-input-inline">
              ...
              <div class="layui-form-mid layui-word-aux">
                  <span class="x-red">*</span>帖子分类信息Id
              </div>
          </div>
          <div class="layui-form-item">
