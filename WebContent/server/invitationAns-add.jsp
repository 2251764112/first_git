          ...
          <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
            <div class="blog-content-wrap">
              ...
              <div class="comment-section">
                ...
                <form action="InvitationServlet?op=addans" method="post" class="comment-form">
                  <h5>Leave a comment</h5>
                  <div class="row">
                    <div class="col-12 col-md-6 mb-4">
                      <input type="hidden" class="form-control" name="userId" value="${userId }" placeholder="Full Name">
                    </div>
                    <div class="col-12 col-md-6 mb-4">
                      <input type="hidden" class="form-control" name="" value="${ins.invi.invitationId }" placeholder="Email">
                    </div>
                    <div class="col-12 mb-4">
                      <textarea rows="7" class="form-control" placeholder="Comment"></textarea>
                    </div>
                  </div>
                  <button class="btn btn-solid">增加回复</button>
                </form>
              </div>
