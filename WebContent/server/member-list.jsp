	...
	<div class="x-body">
		<div class="layui-row">
			<form class="layui-form layui-col-md12 x-so"
				action="${pageContext.request.contextPath}/UserServlet?op=serach"
				method="post">
				<input class="layui-input" autocomplete="off" placeholder="开始日"
					...
					type="text" name="userid" id="sreachName" value=""
		...
		<button class="layui-btn"
			onclick="x_admin_show('添加用户','${pageContext.request.contextPath }/server/member-add.jsp',800,600)">
					...
					<tr>
						<td>
							<div class="layui-unselect layui-form-checkbox"
								lay-skin="primary" data-id='${user.userId }'>
								<i class="layui-icon">&#xe605;</i>
							</div>
						</td>
						<td>${user.userId }</td>
						...
						<td class="td-manage"><a onclick="member_stop(this,'10001')"
							href="javascript:;" title="降级"> <i class="layui-icon">&#xe601;</i>
						</a> <%-- <a class="layui-btn layui-btn-mini layui-btn-normal" lay-event="edit" href="${pageContext.request.contextPath}/UserServlet?op=findEdit&userId=${user.userId}">编辑</a> --%>
							<a title="编辑"
							onclick="x_admin_show('编辑','${pageContext.request.contextPath}/UserServlet?op=findEdit&userId=${user.userId}',600,400)"
							href="javascript:;"> <i class="layui-icon">&#xe642;</i>
						</a> <a onclick="x_admin_show('修改密码','member-password.jsp',600,400)"
							title="修改密码" href="javascript:;"> <i class="layui-icon">&#xe631;</i>
						</a> <a title="删除" onclick="member_del(this,'${user.userId}')"
							href="javascript:;"> <i class="layui-icon">&#xe640;</i>
						</a></td>
					</tr>
				</c:forEach>
