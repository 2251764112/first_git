...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/static/js/cookie.js"></script>
<script>
        // 是否开启刷新记忆tab功能
...
<body>
	...
	<div class="container">
		<div class="logo">
			<a href="${pageContext.request.contextPath }/UserServlet?op=index">X-admin
				v2.1</a>
		</div>
		<div class="left_open">
		...
		<ul class="layui-nav left fast-add" lay-filter="">
			<li class="layui-nav-item"><a href="javascript:;">+新增</a>
				<dl class="layui-nav-child">
					...
					<dd>
						<a onclick="x_admin_show('用户','https://www.baidu.com')"><i
							class="iconfont">&#xe6b8;</i>用户</a>
					</dd>
					<dd>
						<a
							onclick="x_admin_add_to_tab('在tab打开','https://www.baidu.com',true)"><i
							class="iconfont">&#xe6b8;</i>在tab打开</a>
					</dd>
				</dl></li>
		</ul>
		<ul class="layui-nav right" lay-filter="">
			<li class="layui-nav-item"><a href="javascript:;">${userId }</a>
				<dl class="layui-nav-child">
					<!-- 二级菜单 -->
					<dd>
						<a
							onclick="x_admin_show('个人信息','${pageContext.request.contextPath}/UserServlet?op=findEdit&userId=${userId}')">个人信息</a>
					</dd>
					<dd>
						<a onclick="x_admin_show('切换帐号','login.html')">切换帐号</a>
					</dd>
					<dd>
						<a
							href="${pageContext.request.contextPath }/UserServlet?op=loginOut">退出</a>
					</dd>
				</dl></li>
		...
		<div id="side-nav">
			<ul id="nav">
				<li><a href="javascript:;"> <i class="iconfont">&#xe6b8;</i>
					...
					<ul class="sub-menu">
						<li date-refresh="1"><a _href="server/member-list.jsp"> <i
				...
				<li><a href="javascript:;"> <i class="iconfont">&#xe723;</i>
						<cite>帖子管理</cite> <i class="iconfont nav_right">&#xe697;</i>
				</a>
					<ul class="sub-menu">
						<li><a _href="${pageContext.request.contextPath }/InvitationServlet?op=show"> <i class="iconfont">&#xe6a7;</i>
								<cite>帖子列表</cite>
						</a></li>
					</ul></li>
				<li><a href="javascript:;"> <i class="iconfont">&#xe723;</i>
						<cite>模块管理</cite> <i class="iconfont nav_right">&#xe697;</i>
				</a>
					<ul class="sub-menu">
						<li><a _href="${pageContext.request.contextPath }/PlateServlet?op=show"> <i class="iconfont">&#xe6a7;</i>
								<cite>模块列表</cite>
						</a></li>
					</ul></li>
				<li><a href="javascript:;"> <i class="iconfont">&#xe726;</i>
