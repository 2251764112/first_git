		...
		<form class="layui-form">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="L_email" name="userEmail" required=""
						lay-verify="userEmail" autocomplete="off" class="layui-input"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="L_username" name="userId" required=""
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="password" id="L_pass" name="userpsw" required=""
						lay-verify="userpsw" autocomplete="off" class="layui-input"
						value="${user.userpsw }">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<c:if test="${user.userSex eq '男' }" var="isCheck">
						<input type="radio" id="L_username" name="userSex" value="男"
							lay-verify="userSex" autocomplete="off" class="layui-input"
							checked="checked">男
                  <input type="radio" id="L_username" name="userSex"
							value="女" required="" lay-verify="userSex" autocomplete="off"
							class="layui-input">女
              	  </c:if>
					<c:if test="${!isCheck }">
						<input type="radio" id="L_username" name="userSex" value="男"
							lay-verify="userSex" autocomplete="off" class="layui-input">男
                  	<input type="radio" id="L_username" name="userSex"
							value="女" required="" lay-verify="userSex" autocomplete="off"
							class="layui-input" checked="checked">女
                  </c:if>
				</div>
			</div>
			<div class="layui-form-item">
