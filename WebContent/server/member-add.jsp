...
<body>
	<div class="x-body">
		<form class="layui-form" id="apk_add_form"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="L_email" name="userEmail" value=""
						required="" lay-verify="userEmail" autocomplete="off"
						class="layui-input">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="password" id="L_pass" name="userpsw" value=""
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					...
					<input type="radio" id="L_username" name="userSex" value="女"
						required="" lay-verify="userSex" autocomplete="off"
						class="layui-input">女
				</div>
			</div>
			<div class="layui-form-item">
				<label for="L_username" class="layui-form-label"> <span
					class="x-red">*</span>添加头像
				</label>
				<div class="layui-input-inline">
